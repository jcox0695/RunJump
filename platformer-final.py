...
happy = load_image('assets/images/characters/platformChar_happy.png')
spikeman = load_image('assets/images/Enemies/spikeMan_stand.png')
spikeball = load_image('assets/images/Enemies/spikeBall1.png')
flyman = load_image('assets/images/Enemies/flyMan_stand.png')
...
tile_images = { "Grass": load_image('assets/images/tiles/platformPack_tile001.png'),
                ...
                "SpaceFloor": load_image('assets/images/tiles/platformPack_tile016.png'),
                "SpacePlatform": load_image('assets/images/tiles/platformPack_tile041.png'),
                "SpaceGrass": load_image('assets/images/Environment/grass_brown2.png'),
                "WaterFloor": load_image('assets/images/tiles/platformPack_tile027.png'),
                "MarsFloor": load_image('assets/images/tiles/platformPack_tile018.png'),
                "MarsPlatform": load_image('assets/images/tiles/platformPack_tile020.png')}
                
        
basic_enemy_images = { "walk1": load_image('assets/images/Enemies/spikeMan_stand.png') }

platform_enemy_images = { "walk1": load_image('assets/images/Enemies/spikeBall1.png') } 

flyman_enemy_images = { "walk1": load_image('assets/images/Enemies/flyMan_stand.png')}
...
class Hero(pygame.sprite.Sprite):
    ...
    def set_image(self, level):
        if self.vy != 0 and self.vx > 0:
            ...
            self.image = flip_image(jump)
        elif self.walk % 2 == 0 and self.vx > 0:
            self.image = walk1
        elif self.walk % 2 != 0 and self.vx > 0:
            self.image = walk2
        elif self.walk % 2 == 0 and self.vx < 0:
            self.image = flip_image(walk1)
        elif self.walk % 2 != 0 and self.vx < 0:
            self.image = flip_image(walk2)
        else:
            self.image = idle
...
class BasicEnemy(pygame.sprite.Sprite):
    ...
    def set_image(self, level):
        if self.walk % 2 == 0 and self.vx < 0:
            self.image = spikeman
        elif self.walk % 2 != 0 and self.vx < 0:
            self.image = spikeman
    ...
    def load_enemies(self):
        ...
        for element in self.map_data['enemies']:
            ...
            if kind == "BasicEnemy":
                ...
                s = FlyEnemy(x, y, flyman_enemy_images)
